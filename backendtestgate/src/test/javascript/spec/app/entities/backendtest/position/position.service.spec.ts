...
describe('Service Tests', () => {
  describe('Position Service', () => {
    ...
    beforeEach(() => {
      ...
      elemDefault = new Position(0, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', 'AAAAAAA', currentDate);
    });
    ...
    describe('Service methods', () => {
      it('should find an element', () => {
        const returnedFromService = Object.assign(
          {
            update: currentDate.format(DATE_FORMAT)
          },
          elemDefault
        );
        service
      ...
      it('should update a Position', () => {
        const returnedFromService = Object.assign(
          {
            lowerLeftLatLon: 'BBBBBB',
            upperRightLatLon: 'BBBBBB',
            companyZoneIds: 'BBBBBB',
            result: 'BBBBBB',
            update: currentDate.format(DATE_FORMAT)
          },
          elemDefault
