...
/**
 * Utilities for managing json back from the meep webservice
 * 
 * Compare and actualize two JSON (Save and Remote)
 */
@Service
public class JSONUtilsServiceImpl implements JSONUtilsService {
    ...
    public String compareAndActualizeJSON(String jsonRemote, String jsonSave) {
        ...
        try {
            ...
            log.error("MSG NULL " + exception.getMessage());
        } catch (IOException exception) {
            log.error("IO " + exception.getMessage());
        }
